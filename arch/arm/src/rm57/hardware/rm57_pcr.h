...
/* Register Addresses (PCR frame 2) *****************************************/

/* PCR2 gates the EMAC/EMAC Control/MDIO (PS[29]-PS[31]) and the Ethernet
 * CPPI RAM (PCS[41]) - see SPNS215 "Registers/Memories under PCR2".  The
 * PCS registers are the peripheral *clock* power-down controls (as
 * opposed to PS, which gate the peripheral *register* power-down), and
 * are only defined here because the Ethernet CPPI RAM is the first
 * peripheral this port brings up that lives in a PCS-gated quadrant.
 */

#define RM57_PCR2_PSPWRDWNSET0 (RM57_PCR2_BASE + RM57_PCR_PSPWRDWNSET0_OFFSET)
#define RM57_PCR2_PSPWRDWNSET1 (RM57_PCR2_BASE + RM57_PCR_PSPWRDWNSET1_OFFSET)
#define RM57_PCR2_PSPWRDWNSET2 (RM57_PCR2_BASE + RM57_PCR_PSPWRDWNSET2_OFFSET)
#define RM57_PCR2_PSPWRDWNSET3 (RM57_PCR2_BASE + RM57_PCR_PSPWRDWNSET3_OFFSET)
#define RM57_PCR2_PSPWRDWNCLR0 (RM57_PCR2_BASE + RM57_PCR_PSPWRDWNCLR0_OFFSET)
#define RM57_PCR2_PSPWRDWNCLR1 (RM57_PCR2_BASE + RM57_PCR_PSPWRDWNCLR1_OFFSET)
#define RM57_PCR2_PSPWRDWNCLR2 (RM57_PCR2_BASE + RM57_PCR_PSPWRDWNCLR2_OFFSET)
#define RM57_PCR2_PSPWRDWNCLR3 (RM57_PCR2_BASE + RM57_PCR_PSPWRDWNCLR3_OFFSET)
#define RM57_PCR2_PCSPWRDWNSET0 (RM57_PCR2_BASE + RM57_PCR_PCSPWRDWNSET0_OFFSET)
#define RM57_PCR2_PCSPWRDWNSET1 (RM57_PCR2_BASE + RM57_PCR_PCSPWRDWNSET1_OFFSET)
#define RM57_PCR2_PCSPWRDWNCLR0 (RM57_PCR2_BASE + RM57_PCR_PCSPWRDWNCLR0_OFFSET)
#define RM57_PCR2_PCSPWRDWNCLR1 (RM57_PCR2_BASE + RM57_PCR_PCSPWRDWNCLR1_OFFSET)

/* Register Addresses (PCR frame 3) *****************************************/

#define RM57_PCR3_PSPWRDWNSET0 (RM57_PCR3_BASE + RM57_PCR_PSPWRDWNSET0_OFFSET)
#define RM57_PCR3_PSPWRDWNSET1 (RM57_PCR3_BASE + RM57_PCR_PSPWRDWNSET1_OFFSET)
#define RM57_PCR3_PSPWRDWNSET2 (RM57_PCR3_BASE + RM57_PCR_PSPWRDWNSET2_OFFSET)
#define RM57_PCR3_PSPWRDWNSET3 (RM57_PCR3_BASE + RM57_PCR_PSPWRDWNSET3_OFFSET)
#define RM57_PCR3_PSPWRDWNCLR0 (RM57_PCR3_BASE + RM57_PCR_PSPWRDWNCLR0_OFFSET)
#define RM57_PCR3_PSPWRDWNCLR1 (RM57_PCR3_BASE + RM57_PCR_PSPWRDWNCLR1_OFFSET)
#define RM57_PCR3_PSPWRDWNCLR2 (RM57_PCR3_BASE + RM57_PCR_PSPWRDWNCLR2_OFFSET)
#define RM57_PCR3_PSPWRDWNCLR3 (RM57_PCR3_BASE + RM57_PCR_PSPWRDWNCLR3_OFFSET)

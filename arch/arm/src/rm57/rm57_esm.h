...
#ifndef __ARCH_ARM_SRC_RM57_RM57_ESM_H
#define __ARCH_ARM_SRC_RM57_RM57_ESM_H
 ...
 *
 * Description:
 *   Put the Error Signaling Module into a known, quiet state early in
 *   boot: all error-pin channels and interrupts disabled, all latched
 *   status flags cleared, the nERROR pin released.
 *
 ****************************************************************************/
